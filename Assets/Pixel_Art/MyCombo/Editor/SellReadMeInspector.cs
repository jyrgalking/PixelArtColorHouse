...
public class SellReadMeInspector : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/Pixel_Art/MyCombo/GameMaster.prefab");
        }
        ...
        {
            Application.OpenURL("https://docs.google.com/document/d/1xpOcKIjSpbd6-_6ZmGr8_bR8Rvtx79DJhJS75OgbjSA/edit?usp=sharing");
        }
