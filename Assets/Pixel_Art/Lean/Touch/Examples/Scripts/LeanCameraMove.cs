...
namespace Lean.Touch
{
	...
	public class LeanCameraMove : MonoBehaviour
	{
        ...
        public int RequiredButtonIDInDesktop = -1;
		...
		{
            if (SystemInfo.deviceType == DeviceType.Desktop && RequiredButtonIDInDesktop != -1 && !Input.GetMouseButton(RequiredButtonIDInDesktop)) return;
